 ...
 * @date 2018/9/26
 */
public class BacnetClient {public static void main(String[] args) throws Exception {
    IpNetwork ipNetwork = new IpNetworkBuilder().withBroadcast("30.1.255.255", 16).withLocalNetworkNumber(1)
        .withPort(47808).build();
    ...
    Address address = new Address(1, IpNetworkUtils.toOctetString("30.1.224.30", 47808));
